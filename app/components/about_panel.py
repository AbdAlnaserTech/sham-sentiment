"""Modern About page — graduation project presentation."""
...
MODEL_DISPLAY_NAME = "[اسم النموذج المستخدم]"  # e.g. BERT / XLM-RoBERTa
    ...
    st.markdown(
        ...
        <section class="about-section">
            ...
            <p class="about-section-lead">
                يستخدم النظام تقنيات <strong>معالجة اللغة الطبيعية (NLP)</strong>
    ...
    st.markdown(
        ...
        <section class="about-section">
            ...
            <div class="about-workflow">
                ...
                <span class="about-wf-arrow">←</span>
    ...
    st.markdown(
        ...
        <section class="about-section">
            ...
            <div class="about-tech-grid">
                <span class="about-tech-badge">Python</span>
                <span class="about-tech-badge">Natural Language Processing (NLP)</span>
                <span class="about-tech-badge">Text Preprocessing</span>
                <span class="about-tech-badge">Artificial Intelligence</span>
                <span class="about-tech-badge">Sentiment Classification</span>
                <span class="about-tech-badge model">{MODEL_DISPLAY_NAME}</span>
            </div>
        </section>
        """,
        unsafe_allow_html=True,
